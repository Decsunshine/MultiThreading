...
//  MultiThreading
//
//  Created by lu hongliang on 2019/3/20.
...
- (void)dispatchSemaphoreDemo {
    ...
    dispatch_semaphore_wait(semaphore, DISPATCH_TIME_FOREVER);  // dispatch_semaphore_wait 执行之后，会把信号量减一
    NSLog(@"continue");
}
